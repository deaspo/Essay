...
% University of Stellenbosch, South Africa
{\small Supervised by: Dr. Timothy Burns}\\
{\small Swansea University, United Kingdom}%
% Don't put the department, it becomes too long.
}

\date{{\small 3rd July 2015}\\%
  {\scriptsize\it Submitted in partial fulfillment of 
    a structured masters degree at AIMS Tanzania}\\%
  %\vspace{0.5cm}{\includegraphics{images/AIMS_Logo_square-300.jpg}}}
   \vspace{0.5cm}{\includegraphics[width=8cm]{images/AIMS_TZ_Logo.png}}}
